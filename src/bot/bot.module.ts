...
import {SetupBlockClients} from "./setupBlockClients";

@Module({
    providers: [BotUpdate, ClientScene, BotService, RenameClientScene, CreateClientScene, ProlongationClientScene, SetupBlockClients],
})
